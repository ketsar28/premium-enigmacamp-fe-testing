...
WebUI.click(findTestObject('Object Repository/Profile - Security - Objects/Update Profile Security/Page_Premium Class/div_4ProfileSecurityProfile Back General In_679758'))

WebUI.click(findTestObject('Object Repository/Profile - Security - Objects/Update Profile Security/Page_Premium Class/div_4ProfileSecurityProfile Back General In_6a78ab'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Profile - Security - Objects/Update Profile Security/Page_Premium Class/span_Password is required'), 
    5)
